...
namespace Ember.IO
{
    ...
    public static class DefaultPropertiesCreator
    {
        ...
        public static Dictionary<string, List<PropertyItem>> DefaultProperties { get; set; } = new Dictionary<string, List<PropertyItem>>()
        {
            ...
            {
                new PropertyItem("Enable Antialiasing", "Smooths out sharp edges", "Antialiasing", false, typeof(bool)),
            ...
            { "Performance", new List<PropertyItem>()
            {
                ...
                new PropertyItem("Show Character Inking", "Draws a thin black outline around characters", "CharacterInking", false, typeof(bool)),
                new PropertyItem("Enable HUD Animations", "Some HUD elements will have animations", "EnableHUDAnimations", false, typeof(bool)),
                new PropertyItem("Enable Grass Swaying", "Bushes will sway when you step into them", "EnableGrassSwaying", false, typeof(bool)),
